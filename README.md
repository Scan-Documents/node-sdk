...
```sh
npm install git+ssh://git@github.com:stainless-sdks/scan-documents-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install scan-documents`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/scan-documents-typescript/issues) with questions, bugs, or suggestions.
